        ...
        switch (Data.Action) {
            ...
            case 'SetMenuVisiblity':
                if (!Data.Show) {
                    ...
                    $.post("https://fw-bennys/PreviewUpgrade", JSON.stringify({
                        Menu: NewMenu.Name,
    ...
    if (InMenu) {
        switch (e.keyCode) {
            case 38: // Arrow Up
                ...
                $.post("https://fw-bennys/PlaySoundFrontend", JSON.stringify({
                    Name: 'NAV_UP_DOWN',
            ...
            case 13: // Enter
                ...
                if (Menu.Data.Items[Menu.Data.SelectedIndex - 1].TargetMenu == undefined) {
                    $.post("https://fw-bennys/PurchaseUpgrade", JSON.stringify({
                        Menu: Menu.Name,
                        Index: Menu.Data.SelectedIndex,
                    }))
                } else {
                    $.post("https://fw-bennys/OpenTargetMenu", JSON.stringify({
            ...
            case 8: // Backspace
                ...
                if (Menu != undefined && Menu.Data != undefined && Menu.Data.Parent == undefined) {
                    $.post("https://fw-bennys/CloseBennys");
