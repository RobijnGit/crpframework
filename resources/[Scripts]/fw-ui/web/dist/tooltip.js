(function($) {
    ...
    Hint.prototype = {
        ...
        calculatePosition: function() {
            ...
            var arrowOffset = actualWidth / 2;
        
            // Adjust tooltip position if it goes out of the screen horizontally
            if (tp.left + actualWidth > windowWidth) {
                tp.left = windowWidth - actualWidth;
                arrowOffset = pos.left + pos.width / 2 - tp.left;
            } else if (tp.left < 0) {
                tp.left = 0;
                arrowOffset = pos.left + pos.width / 2;
            }
        
            // Adjust tooltip position if it goes out of the screen vertically
            ...
            if (gravity.charAt(0) === 'n' || gravity.charAt(0) === 's') {
                $tip.find('.tooltip-css-arrow')[0].style.left = arrowOffset + 'px';
            }
        },
