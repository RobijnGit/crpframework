                ...
                if prevPos ~= nil then
                    if currentPos == prevPos then
                        if time ~= nil then
                            if time > 0 then
                                if time == 60 then
                                    FW.Functions.Notify('You\'re AFK and will be kicked in ' .. math.ceil(time / 60) .. ' minutes!', 'error', 10000)
                                elseif time == 30 then
                                    FW.Functions.Notify('You\'re AFK and will be kicked in ' .. time .. ' seconds!', 'error', 10000)
                                elseif time == 20 then
                                    FW.Functions.Notify('You\'re AFK and will be kicked in ' .. time .. ' seconds!', 'error', 10000)
                                elseif time == 10 then
                                    FW.Functions.Notify('You\'re AFK and will be kicked in ' .. time .. ' seconds!', 'error', 10000)
