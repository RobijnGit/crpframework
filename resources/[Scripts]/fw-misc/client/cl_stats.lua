...
Citizen.CreateThread(function()
    while true do
        ...
        if HasPauseMenu ~= _HasPauseMenu then
            ...
            TriggerEvent('fw-misc:Client:PauseMenuActive', _HasPauseMenu)
        end
...
RegisterNetEvent("fw-misc:Client:PauseMenuActive")
AddEventHandler("fw-misc:Client:PauseMenuActive", function(Active)
