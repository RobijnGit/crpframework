...
AddEventHandler('fw-items:use:item:anker', function(Source) 
    ...
    if GetVehicleClass(Vehicle) == 14 then
        if not exports['fw-progressbar']:GetTaskBarStatus() then
            ...
            FW.Functions.Progressbar("use_anker", "Using anchor..", 5000, false, true, {}, {}, {}, {}, function() -- Done
                ...
                FW.Functions.Notify('You\'ve dropped the anchor.', 'success')
            end)
        end
    end
end)
                ...
                if IsPedInAnyVehicle(PlayerPedId(), true) then
                    ...
                    if not IsPedSittingInAnyVehicle(PlayerPedId()) then
                        ...
                        if not ShowedNotify then 
                            if Count == 2 then
                                FW.Functions.Notify('Your anchor is still out!', 'error')
                                ShowedNotify = true
                                Count = 0
                            end
                        end
