...
FW.RegisterServer("fw-jobmanager:Server:Taxi:DeletePed", function(Source, NetId, Distance)
    ...
    TriggerClientEvent('fw-phone:Client:Notification', Player.PlayerData.source, "jobcenter-paycheck", "fas fa-home", {"white", "rgb(38, 50, 56)"}, "Job Center", exports['fw-businesses']:NumberWithCommas(Earnings) .. ' has been transfered to your bank account.')
    exports['fw-financials']:AddMoneyToAccount("1001", "1", Player.PlayerData.charinfo.account, Earnings, 'PAYMENT', 'Rdie: ' .. string.format("%.2f", Distance / 1000) .. " km")
end)