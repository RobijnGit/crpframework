...
function LoadFilters()
    ...
    if Config.EnablePhone then
        ...
        SetAudioSubmixEffectParamFloat(PhoneSubmix, 1, GetHashKey('freq_hi'), 7000.0)
        SetAudioSubmixEffectParamFloat(PhoneSubmix, 1, GetHashKey('rm_mod_freq'), 150.0)
        SetAudioSubmixEffectParamFloat(PhoneSubmix, 1, GetHashKey('rm_mix'), 0.1)
        SetAudioSubmixEffectParamFloat(PhoneSubmix, 1, GetHashKey('fudge'), 3.0)
        SetAudioSubmixEffectParamFloat(PhoneSubmix, 1, GetHashKey('o_freq_lo'), 200.0)
        SetAudioSubmixEffectParamFloat(PhoneSubmix, 1, GetHashKey('o_freq_hi'), 7000.0)
...
function SetSubmixBalanceVolume(SubmixName, Volume)
    if SubmixName == nil then return end

    if SubmixName == 'RadioSubmix' then
        SetAudioSubmixOutputVolumes(RadioSubmixFar, 0, Volume, 0.2, Volume, 0.2)
        SetAudioSubmixOutputVolumes(RadioSubmixMedium, 0, Volume, 0.2, Volume, 0.2)
        SetAudioSubmixOutputVolumes(RadioSubmix, 0, Volume, 0.2, Volume, 0.2)
    elseif SubmixName == 'PhoneSubmix' then
        SetAudioSubmixOutputVolumes(PhoneSubmix, 0, 0.2, Volume, 0.2, Volume)
    end
end